...
import './navbar.css'
function Navbar({scrollTo, visibleCount}:{scrollTo:(sec:number)=>void;visibleCount:number }) {
   
    
  return (
    <div className='nav'>
     <ul className="nav-list">
        <li className={`nav-item ${visibleCount ===1?'active':''}`} onClick={(e)=>scrollTo(1)} >
        ...
        <li className={`nav-item ${visibleCount ===2?'active':''}`}   onClick={(e)=>scrollTo(2)}>
        ...
        <li className={`nav-item ${visibleCount ===3?'active':''}`}  onClick={(e)=>scrollTo(3)}>
        ...
        <li className={`nav-item ${visibleCount ===4?'active':''}`}  onClick={(e)=>scrollTo(4)}>
        ...
        <li className={`nav-item ${visibleCount ===5?'active':''}`}  onClick={(e)=>scrollTo(5)}>
